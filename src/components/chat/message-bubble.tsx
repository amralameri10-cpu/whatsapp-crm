...
import { Check, CheckCheck, Clock, AlertCircle, FileText, Mic, Image, Film, MapPin, User, BarChart3 } from 'lucide-react';
    ...
    <div className={cn('flex mb-1.5', isMe ? 'justify-end' : 'justify-start')}>
      ...
      >
        ...
        {message.messageType === 'video' && message.mediaUrl && (
          <video src={message.mediaUrl} controls className="rounded-lg mb-1.5 max-h-64 max-w-full" />
        )}
        ...
        {/* Show media type indicator even when there's no text */}
        {Icon && !message.text && !message.mediaUrl && message.messageType !== 'sticker' && message.messageType !== 'protocol' && (
        ...
        {message.messageType === 'sticker' && !message.text && (
